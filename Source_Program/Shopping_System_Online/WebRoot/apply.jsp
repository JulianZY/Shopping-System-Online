...
<html>
  ...
  <div id="content">
  <table>
    <s:form action="apply" validate="true">
        <tr><td>店主姓名(不要包含特殊英文字符)：</td><td><input type="text" name="bossname"/></td><td><s:fielderror fieldName="bossname" cssStyle="color: red"/></td></tr>
       ...
       <tr><td>地址： </td><td><input type="text" name="adress"/></td><td></td></tr>
        <tr><td>真实姓名(不要包含特殊英文字符)：</td><td><input type="text" name="truename"/></td><td><s:fielderror fieldName="truename" cssStyle="color: red"/></td></tr>
         <tr><td>店铺地址：</td><td><input type="text" name="shopadress"/></td><td></td></tr>
        <tr><td>店铺名(不要包含特殊英文字符)：</td><td><input type="text" name="shopname"/></td><td><s:fielderror fieldName="shopname" cssStyle="color: red"/></td></tr>
        <tr><td><s:submit value="注册" /></td><td><s:reset value="重置"/></td><td></td></tr>
        </s:form>
        </table>
        <br>
